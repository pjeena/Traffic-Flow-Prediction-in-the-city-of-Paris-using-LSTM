...
#        df_junction = df_junction[columns_of_interest]
        ...
        df_junction = df_junction.fillna(0.0)


        df_junction['2_wheelers'] = df_junction['2 roues motorisées'] + df_junction['Trottinettes'] + df_junction['Trottinettes + vélos'] + df_junction['Vélos']
        df_junction['4_wheelers'] = df_junction['Véhicules légers < 3,5t'] + df_junction['Véhicules lourds > 3,5t'] + df_junction['Autobus et autocars']
        df_junction['t'] = pd.to_datetime(df_junction['t'])

        columns_of_interest = ['label','latitude','longitude','t', '2_wheelers', '4_wheelers']
        df_junction = df_junction[columns_of_interest]
